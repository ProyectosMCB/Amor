...
const nivelesJuegoOriginales = [
    ...
    { tipo: "audio", archivo: "Audio/A6.mp3", acertijo: "¿Cuál fue el primer sitio al que fuimos a dar una vuelta lejos de la U?", opciones: ["El centro", "El Parque de las Aguas", "Real Plaza", "Un parque cualquiera"], correcta: 1 },
    ...
    { tipo: "audio", archivo: "Audio/A9.mp3", acertijo: "Haciendo memoria del polo que me diste de regalo... ¿de qué color era?", opciones: ["Negro", "Plomo", "Azul", "Blanco"], correcta: 2 },
    { tipo: "audio", archivo: "Audio/A10.mp3", acertijo: "¿Qué fue lo primero físico que te entregué como detalle al principio?", opciones: ["Un peluche", "Un chocolate", "Rrosas", "Una carta"], correcta: 2 },
    ...
    { tipo: "audio", archivo: "Audio/A12.mp3", acertijo: "Cuando te di un detalle con moño, ¿qué tono exacto era?", opciones: ["Rojo entero", "Conchivino", "Rosado bajito", "Morado oscuro"], correcta: 1 },
